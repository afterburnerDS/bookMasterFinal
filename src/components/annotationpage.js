    ...
    render() {
        ...
        return (
            <main className="container">
                ...
                <div className="editBtn "> <Link className="editBtnLink btn btn-lg btn-primary" to={`/editannotation/${this.props.idBook}/${this.props.idAnnot}`}>Edit Annotation </Link></div>
